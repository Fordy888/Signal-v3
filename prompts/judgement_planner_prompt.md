...
- Every reader-facing headline must end as a complete phrase. Never finish on an article, preposition, conjunction, possessive or dangling qualifier such as `a`, `the`, `in`, `not`, `just`, `your` or `with`.
